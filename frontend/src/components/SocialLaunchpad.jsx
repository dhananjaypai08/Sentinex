...
const SocialLaunchpad = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(!tokenInfoData.name || !tokenInfoData.symbol || !tokenInfoData.initialSupply || tokenInfoData.owner == "") {
      ...
      try{
        const tweetContent = `JUST IN!! Someone deployed their own token $${tokenInfoData.symbol} named: ${tokenInfoData.name} on Secret Testnet and here is the contract address: ${deployData.contractAddress}`;
